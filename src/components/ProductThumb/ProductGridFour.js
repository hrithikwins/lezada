          ...
          >
              <div className="product-grid product-grid--absolute-content">
                  ...
                  <div className="product-grid__image">
                      <Link
                          href={`/shop/product-basic/[slug]?slug=slugIdHere`}
                          as={
                  ...
                  <div className="product-grid__content">
                      ...
                      <div className="price">
                          {/* {product.discount > 0 ? ( */}
                          <Fragment>
                              <span className="main-price discounted">149</span>
                              <span className="discounted-price">149</span>
                          </Fragment>
                          {/* ) : (
