...
const getIndividualItemArray = (array) => {
    let individualItemArray = array.filter(
...
const getIndividualColorObjectArray = (array) => {
    let individualObjectArray = array.filter((v, i, self) => {
        return (
            ...
            self.findIndex(
                (t) =>
                    t.colorName === v.colorName && t.colorCode === v.colorCode
            )
        );
    });
...
export const getIndividualColors = (products) => {
    ...
    const individualProductColors =
        getIndividualColorObjectArray(productColors);
